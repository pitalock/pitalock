...
Pre-1.0, pre-audit. The `docs/` directory contains design documentation. **The repo does not yet contain application code** — v0.1 implementation has not yet started or is just beginning. Update this section as work progresses.
